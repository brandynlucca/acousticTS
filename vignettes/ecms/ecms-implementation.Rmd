...
The implementation check uses an independent direct transcription of the Faran-Stanton algebra. That is useful for confirming that the package code path reproduces the intended elastic-cylinder algebra on a shared grid.

::: {.experiment data-title="Current scope"}
`ECMS` remains experimental while the public elastic-cylinder surface is limited to the current broadside FEM validation row.
:::
