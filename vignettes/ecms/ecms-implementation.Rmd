...
finite-length approximation [@Faran_1951; @Stanton_1988].
...
ECMS is not claimed as externally validated. The documented check establishes
agreement with an independent transcription of the elastic-cylinder algebra
over the full comparison band.
