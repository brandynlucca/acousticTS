...
The stochastic distorted wave Born approximation (SDWBA) begins with the same weak-scattering derivation as the deterministic DWBA, then modifies the phase structure of the coherent sum to account for unresolved variability in body shape, posture, and internal structure [@demer_reconciling_2003; @conti_improved_2006; @stanton_sound_1998i].
