...
SDWBA applies stochastic phase variability to the segment contributions of a
DWBA target [@Demer_2003_1; @Demer_2003_2; @Conti_2006; @Demer_2005].
...
The following comparison uses the exact modal-series `Benchmark` column in the
Jech weakly scattering sphere, prolate-spheroid, and cylinder files
[@Jech_2015].
