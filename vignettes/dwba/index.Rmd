...
acousticTS:::.model_family_overview(
  ...
  supports = c(
    ...
    paste0(
      "Material contrasts expressed naturally as $g_{21}$ and $h_{21}$ ",
  ...
  reading = c(
    paste0(
      "[Implementation](dwba-implementation.html): object workflows, ",
      "spectra, and validation tables"
    ),
    paste0(
      "[Theory](dwba-theory.html): Born linearization, contrast term, and ",
      "centerline integral"
    )
  )
)
