...
acousticTS:::.model_family_overview(
  ...
  reading = c(
    paste(
      "[Implementation](dwba-implementation.html): object preparation,",
      "discretization, output, and comparisons"
    ),
    paste(
      "[Theory](dwba-theory.html): weak-scattering contrast and centerline",
      "integral"
    )
  )
)
