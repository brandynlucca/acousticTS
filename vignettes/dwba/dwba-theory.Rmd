...
The distorted wave Born approximation (DWBA) is a first-order scattering model for weakly scattering fluid-like bodies. It is most useful when the material contrasts are small enough that the total acoustic field inside the body remains close to the incident field, but the geometry is sufficiently extended that phase accumulation along the body cannot be ignored [@morse_theoretical_1986; @stanton_sound_1998]. In that regime, a purely local approximation is too crude, while a full boundary-value solution is often unnecessary or unavailable.
