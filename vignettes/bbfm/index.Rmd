...
acousticTS:::.model_family_overview(
  ...
  reading = c(
    ...
    "[Validation](bbfm-validation.html): hybrid FEM-BEM composite checks",
...
`BBFM` is a partially validated experimental family. The validation page
checks the complete body-plus-backbone response against hybrid FEM-BEM
cases over frequency, orientation, length, radius, material, and
modal-truncation scenarios.
:::
