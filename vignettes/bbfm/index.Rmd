...
acousticTS:::.model_family_overview(
  ...
  supports = c(
    paste0(
      "`BBF` scatterers built from explicit `body_shape` and ",
      "`backbone_shape` inputs"
    ),
    paste0(
  ...
  reading = c(
    paste0(
      "[Implementation](bbfm-implementation.html): object setup, stored ",
      "outputs, and internal reconstruction checks"
    ),
    paste0(
      "[Theory](bbfm-theory.html): composite amplitude, phase placement, and ",
