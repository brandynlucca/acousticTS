...
acousticTS:::.model_family_overview(
  ...
  reading = c(
    "[Implementation](bbfm-implementation.html): object setup, stored outputs, and coherent reconstruction checks",
    "[Validation](bbfm-validation.html): BEM/FEM component checks and coherent-sum table",
...
`BBFM` is a partially validated experimental family. The current validation
claim covers the component paths and coherent bookkeeping shown on the
validation page; the model remains a first-order component surrogate rather
than a fully coupled embedded-backbone boundary-value solve.
:::
