...
ESSMS does have a direct benchmark source in the Jech shell-sphere family. The full-grid ESSMS sweep is a status check rather than a usable $\Delta$ table because the implementation does not return finite `TS` values across the benchmark grid.
