...
`ESSMS` remains unvalidated in the package. The benchmark family exists, but the current implementation still does not return finite full-grid `TS` values across those shell-sphere comparison sweeps, so this page is documenting behavior and limitations rather than benchmark-grade agreement.
:::
