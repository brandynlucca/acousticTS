...
acousticTS:::.model_family_overview(
  ...
  best_for = c(
    ...
    paste(
      "Canonical layered-sphere calculations where shell elasticity must",
      "be retained"
    )
  ),
  supports = c(
  ...
  reading = c(
    paste(
      "[Implementation](essms-implementation.html): object construction,",
      "output, and current validation scope"
    ),
    paste(
      "[Theory](essms-theory.html): layered fields, interface tractions,",
      "and modal systems"
    )
  )
)
