...
acousticTS:::.model_family_overview(
  ...
  supports = c(
    ...
    paste0(
      "Exterior seawater (medium `1`), shell (medium `2`), and interior ",
      "fluid or cavity (medium `3`)"
    ),
  ...
  reading = c(
    paste0(
      "[Implementation](essms-implementation.html): current usage and ",
      "validation status"
    ),
    paste0(
      "[Theory](essms-theory.html): full layered shell derivation, ",
      "tractions, and mode-wise boundary systems"
    )
  )
)
```
