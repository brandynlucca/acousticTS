...
![Shape-selection spectrum](building-shapes-spectrum.svg)
...
The second figure is useful here because it makes that tradeoff explicit. The further a body departs from a separable canonical surface, the stronger the case becomes for preserving the measured morphology rather than forcing the target into an overly simple idealized form.
