...
After geometry construction, [prepare the material properties](../material-properties/material-properties.html)
that describe the target and its reference medium. Then continue to
[Building Scatterers](../building-scatterers/building-scatterers.html) to attach
those properties to the shape and create a model-ready acoustic target.
