---
title: "Plotting and Inspecting Results"
output:
...
vignette: >
  %\VignetteIndexEntry{Plotting and Inspecting Results}
...
Plot inspection is most useful when curves are read against known benchmark shapes, resonances, and asymptotic regimes from the published scattering literature [@foote_spheres_1990; @jech_etal_2015].
