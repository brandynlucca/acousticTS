...
acousticTS:::.model_family_overview(
  ...
  reading = c(
    "[Implementation](vesm-implementation.html): layered-object workflow and model outputs",
    "[Benchmarks](vesm-benchmarks.html): layered-sphere comparison table",
    "[Validation](vesm-validation.html): radial FEM check for the documented layered sphere",
