...
acousticTS:::.model_family_overview(
  ...
  supports = c(
    ...
    "Run-time viscous-layer density, sound speed, shear viscosity, bulk viscosity, and thickness or 
    radius",
  ...
  reading = c(
    "[Implementation](vesm-implementation.html): building the layered object, required arguments, 
