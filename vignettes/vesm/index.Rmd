...
acousticTS:::.model_family_overview(
  ...
  reading = c(
    paste(
      "[Implementation](vesm-implementation.html): building the layered",
      "object, required arguments, and output"
    ),
    paste(
      "[Theory](vesm-theory.html): fields in all four regions and interface",
      "systems"
    )
  )
)
