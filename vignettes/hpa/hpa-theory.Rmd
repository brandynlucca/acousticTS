...
![HPA geometry factors for spheres, prolate spheroids, straight cylinders, and bent cylinders.](hpa-geometry-factors.svg)
...
For a sphere, the generalized expression from Stanton (1989)[^3] is:
...
The low-frequency numerator is still the Rayleigh term. The denominator is now written so that the high-frequency scale is set explicitly by the reflection coefficient $\mathcal{R}$. Compared with the simpler form of Johnson (1977; 1978)[^1][^2], the version from Stanton (1989)[^3] makes the reflection-controlled nature of the large-$ka$ limit more explicit and leaves room for the correction factors $\mathcal{F}$ and $\mathcal{G}$.
