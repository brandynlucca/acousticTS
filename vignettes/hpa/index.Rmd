...
acousticTS:::.model_family_overview(
  ...
  best_for = c(
    paste(
      "Rapid broadband trend calculations for spheres, prolate spheroids,",
      "and cylinders"
    ),
  ...
  reading = c(
    paste(
      "[Implementation](hpa-implementation.html): method selection, supported",
      "shapes, output, and comparisons"
    ),
    paste(
      "[Theory](hpa-theory.html): low-frequency term, reflection limit, and",
