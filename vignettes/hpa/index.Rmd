...
acousticTS:::.model_family_overview(
  ...
  reading = c(
    "[Implementation](hpa-implementation.html): quick workflows and model outputs",
    "[Benchmarks](hpa-benchmarks.html): canonical targets and formula reproduction tables",
    "[Validation](hpa-validation.html): BEM check for the liquid-filled Stanton sphere branch",
