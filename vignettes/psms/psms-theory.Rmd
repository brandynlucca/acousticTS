...
<!-- ![PSMS coordinate geometry in the meridional plane, showing focal points, the boundary surface $\xi = \xi_1$, and representative $\xi$- and $\eta$-coordinate curves.](psms-coordinate-geometry-clean.svg) -->
...
<!-- ![Projection of exterior angular modes onto the interior spheroidal basis in
the fluid-filled PSMS system.](psms-overlap-projection-schematic.svg) -->
