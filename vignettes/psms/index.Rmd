...
acousticTS:::.model_family_overview(
  ...
  reading = c(
    paste(
      "[Implementation](psms-implementation.html): supported branches,",
      "numerical controls, output, and benchmarks"
    ),
    paste(
      "[Theory](psms-theory.html): spheroidal coordinates, wave functions,",
