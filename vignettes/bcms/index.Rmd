...
acousticTS:::.model_family_overview(
  ...
  reading = c(
    paste0(
      "[Implementation](bcms-implementation.html): usage and current ",
      "reference checks"
    ),
    paste0(
      "[Theory](bcms-theory.html): bent-axis coherence integrals and ",
      "relation to the straight-cylinder modal kernel"
    )
  )
)
```
