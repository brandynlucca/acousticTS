...
acousticTS:::.model_family_overview(
  ...
  reading = c(
    "[Implementation](bcms-implementation.html): curvature input, boundaries, output, and internal checks",
    "[Theory](bcms-theory.html): Fresnel coherence correction and the straight-cylinder limit"
  )
)
```
