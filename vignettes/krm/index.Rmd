...
acousticTS:::.model_family_overview(
  ...
  reading = c(
    paste(
      "[Implementation](krm-implementation.html): building fish objects,",
      "variants, component output, and comparisons"
    ),
    paste(
      "[Theory](krm-theory.html): body term, swimbladder branches, and",
      "coherent sum"
    )
  )
)
