...
acousticTS:::.model_family_overview(
  ...
  reading = c(
    "[Implementation](krm-implementation.html): scatterer setup and spectra",
    "[Benchmarks](krm-benchmarks.html): canonical targets and SBF software-comparison tables",
    "[Validation](krm-validation.html): weak body-branch BEM transmission check",
