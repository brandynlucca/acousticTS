...
acousticTS:::.model_family_overview(
  ...
  reading = c(
    paste0(
      "[Implementation](krm-implementation.html): scatterer setup, spectra, ",
      "and validation tables"
    ),
    paste0(
      "[Theory](krm-theory.html): body Kirchhoff reduction, swimbladder ",
      "mode/ray branches, and coherent composite sum"
    )
  )
)
```
