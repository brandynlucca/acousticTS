...
contrasting swimbladder [@Clay_1991; @Clay_1994].
...
The bundled fish objects serve a different benchmark role from the canonical
modal-series targets. There is no exact modal-series reference for these
segmented body-plus-swimbladder geometries, so they check software agreement
for the `krm_variant` branches. The comparisons include KRMr [@KRMr_software],
echoSMs [@echoSMs_software], and the SWFSC applet [@NOAA_KRM_software].
