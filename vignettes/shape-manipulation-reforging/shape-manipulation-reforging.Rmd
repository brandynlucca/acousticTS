...
`reforge()` is a generic interface for reshaping or resizing an existing object. The most developed method in the package is the `SBF` method, which handles body and swimbladder geometry jointly.
