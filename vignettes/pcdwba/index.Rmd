...
acousticTS:::.model_family_overview(
  ...
  reading = c(
    "[Implementation](pcdwba-implementation.html): object setup and model output",
    "[Benchmarks](pcdwba-benchmarks.html): curved-body implementation comparisons and timing",
    "[Validation](pcdwba-validation.html): direct phase-compensated quadrature matrix",
