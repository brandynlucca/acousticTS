...
acousticTS:::.model_family_overview(
  ...
  reading = c(
    paste0(
      "[Implementation](pcdwba-implementation.html): object workflow and ",
      "comparison results"
    ),
    paste0(
      "[Theory](pcdwba-theory.html): bent-centerline parameterization and ",
      "phase-compensated weak-scattering sum"
    )
  )
)
```
