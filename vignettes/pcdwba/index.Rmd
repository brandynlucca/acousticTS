...
acousticTS:::.model_family_overview(
  ...
  reading = c(
    "[Implementation](pcdwba-implementation.html): accepted profiles, curvature inputs, output, and comparisons",
    "[Theory](pcdwba-theory.html): centerline geometry and phase-compensated sum"
  )
)
```
