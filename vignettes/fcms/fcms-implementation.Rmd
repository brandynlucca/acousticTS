...
FCMS evaluates straight circular cylinders with a finite-length modal-series
approximation [@Stanton_1988; @Stanton_1989_2].
...
FCMS can be compared directly against the Jech cylindrical benchmark family
...
finite-cylinder implementation [@echoSMs_software]. This tests agreement on
the same problem independently of the rounded benchmark values.
