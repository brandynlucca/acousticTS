...
acousticTS:::.model_family_overview(
  ...
  supports = c(
    ...
    paste(
      "Monostatic complex amplitude, backscattering cross-section, and",
      "target strength"
    )
  ),
  assumptions = c(
  ...
  reading = c(
    paste(
      "[Implementation](fcms-implementation.html): cylinder construction,",
      "boundaries, output, and comparisons"
    ),
    paste(
      "[Theory](fcms-theory.html): cylindrical modes, interface conditions,",
      "and finite-length closure"
    )
  )
)
```
