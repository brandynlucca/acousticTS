...
acousticTS:::.model_family_overview(
  ...
  reading = c(
    paste0(
      "[Implementation](fcms-implementation.html): spectra, result ",
      "extraction, and comparison tables"
    ),
    paste0(
      "[Theory](fcms-theory.html): cylindrical modal reduction, boundary ",
      "conditions, and finite-length factorization"
    )
  )
)
```
