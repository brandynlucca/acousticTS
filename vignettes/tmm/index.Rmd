...
acousticTS:::.model_family_overview(
  ...
  core_idea = paste(
    ...
    "current package scope, that gives a reusable single-target retained state",
  ...
  assumptions = c(
    ...
    "Cylinder branch currently has narrower validated scope than sphere, oblate, and prolate branches"
  ),
  reading = c(
    "[Implementation](tmm-implementation.html): stored-state workflows, plots, benchmarks, and current scope",
