...
acousticTS:::.model_family_overview(
  ...
  reading = c(
    "[Implementation](tmm-implementation.html): branch matrix, retained-state workflows, output, and validation",
    "[Theory](tmm-theory.html): coefficient maps, boundary operators, and geometry-matched bases"
  )
)
```

![The supported single-target TMM branches use spherical, spheroidal, or cylindrical coordinates according to target geometry.](tmm-branch-schematic.png)
