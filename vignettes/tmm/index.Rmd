...
acousticTS:::.model_family_overview(
  ...
  supports = c(
    paste(
      "Sphere, oblate-spheroid, prolate-spheroid, and guarded",
      "finite-cylinder branches"
    ),
    paste(
  ...
  assumptions = c(
    paste(
      "A single target represented by one of the documented",
      "geometry-specific bases"
    ),
    paste(
    ...
    paste(
      "Validation and retained-state support differ by geometry and",
      "boundary branch"
    )
  ),
  reading = c(
    paste(
      "[Implementation](tmm-implementation.html): branch matrix,",
      "retained-state workflows, output, and validation"
    ),
    paste(
      "[Theory](tmm-theory.html): coefficient maps, boundary operators, and",
