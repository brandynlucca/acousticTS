...
```{r echo=FALSE, out.width=c('49%','49%'), fig.align='center', fig.alt=c('Pre-rendered TMM minus BEM residual for the fixed-rigid sphere across the full bistatic scattering grid at 12, 38, 70, and 120 kHz.', 'Pre-rendered TMM minus BEM residual for the pressure-release sphere across the full bistatic scattering grid at 12, 38, 70, and 120 kHz.')}
knitr::include_graphics(c("tmm-bempp-sphere-fixed-rigid-delta.png", "tmm-bempp-sphere-pressure-release-delta.png"))
```

```{r echo=FALSE, out.width=c('49%','49%'), fig.align='center', fig.alt=c('Pre-rendered TMM minus BEM residual for the liquid-filled sphere across the full bistatic scattering grid at 12, 38, 70, and 120 kHz.', 'Pre-rendered TMM minus BEM residual for the gas-filled sphere across the full bistatic scattering grid at 12, 38, 70, and 120 kHz.')}
knitr::include_graphics(c("tmm-bempp-sphere-liquid-filled-delta.png", "tmm-bempp-sphere-gas-filled-delta.png"))
```

#### Oblate

```{r echo=FALSE, out.width=c('32%','32%','32%'), fig.align='center', fig.alt=c('Pre-rendered TMM minus BEM residual for the fixed-rigid oblate spheroid across the full bistatic scattering grid at 12, 38, 70, and 120 kHz.', 'Pre-rendered TMM minus BEM residual for the pressure-release oblate spheroid across the full bistatic scattering grid at 12, 38, 70, and 120 kHz.', 'Pre-rendered TMM minus BEM residual for the gas-filled oblate spheroid across the full bistatic scattering grid at 12, 38, 70, and 120 kHz.')}
knitr::include_graphics(c("tmm-bempp-oblate-fixed-rigid-delta.png", "tmm-bempp-oblate-pressure-release-delta.png", "tmm-bempp-oblate-gas-filled-delta.png"))
```

#### Prolate

```{r echo=FALSE, out.width=c('32%','32%','32%'), fig.align='center', fig.alt=c('Pre-rendered TMM minus BEM residual for the fixed-rigid prolate spheroid across the full bistatic scattering grid at 12, 38, 70, and 120 kHz.', 'Pre-rendered TMM minus BEM residual for the pressure-release prolate spheroid across the full bistatic scattering grid at 12, 38, 70, and 120 kHz.', 'Pre-rendered TMM minus BEM residual for the liquid-filled prolate spheroid across the full bistatic scattering grid at 12, 38, 70, and 120 kHz.')}
knitr::include_graphics(c("tmm-bempp-prolate-fixed-rigid-delta.png", "tmm-bempp-prolate-pressure-release-delta.png", "tmm-bempp-prolate-liquid-filled-delta.png"))
```

#### Shell sphere

```{r echo=FALSE, out.width=c('49%','49%'), fig.align='center', fig.alt=c('Pre-rendered TMM minus BEM residual for the shelled pressure-release sphere across the full bistatic scattering grid at 12, 38, 70, and 120 kHz.', 'Pre-rendered TMM minus BEM residual for the shelled gas sphere across the full bistatic scattering grid at 12, 38, 70, and 120 kHz.')}
knitr::include_graphics(c("tmm-bempp-sphere-shelled-pressure-release-delta.png", "tmm-bempp-sphere-shelled-gas-delta.png"))
```

```{r echo=FALSE, out.width=c('49%','49%'), fig.align='center', fig.alt=c('Pre-rendered TMM minus BEM residual for the shelled liquid sphere across the full bistatic scattering grid at 12, 38, 70, and 120 kHz.', 'Pre-rendered TMM minus independent radial finite-element residual for the elastic-shelled sphere across the full bistatic scattering grid at 12, 38, 70, and 120 kHz.')}
knitr::include_graphics(c("tmm-bempp-sphere-shelled-liquid-delta.png", "tmm-bempp-sphere-elastic-shelled-delta.png"))
```
