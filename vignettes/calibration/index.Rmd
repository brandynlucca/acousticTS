...
acousticTS:::.model_family_overview(
  ...
  best_for = c(
    paste0(
      "Calibration spheres made of tungsten carbide, copper, aluminum, ",
      "steel, or similar elastic solids"
    ),
  ...
  reading = c(
    paste0(
      "[Implementation](calibration-implementation.html): calibration ",
      "workflows and benchmark comparisons"
    ),
    paste0(
      "[Theory](calibration-theory.html): elastic-sphere modal theory and ",
