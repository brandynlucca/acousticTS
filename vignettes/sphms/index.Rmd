...
acousticTS:::.model_family_overview(
  ...
  supports = c(
    ...
    paste0(
      "Medium-indexed spherical theory with medium `1` as seawater and ",
      "medium `2` as the sphere interior"
    ),
  ...
  reading = c(
    paste0(
      "[Implementation](sphms-implementation.html): object construction, ",
      "spectra, and software comparisons"
    ),
    paste0(
      "[Theory](sphms-theory.html): full spherical separation, boundary ",
      "conditions, and coefficient derivations"
    )
  )
)
```
