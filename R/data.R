...
#'
#' @format A FFS object comprising all information required for target strength modelling. The variables are as follows:
#' \describe{
...
#' Sample krill shape taken from krill captured in Monterey Bay (2019): *T. spinifera*, *E. pacifica*, and *N. difficilis*.
#'
#' A dataset containing a sample krill captured in Monterey Bay (2019): *T. spinifera*, *E. pacifica*, and *N. difficilis*..
#'
#' @format A FFS object comprising all information required for target strength modelling. The variables are as follows:
#' \describe{
#'   \item{rpos}{Position matrix ([x,y,z], m)[0.0410898,0.0000000,0.0000000] to [0.0000000,0.0000000,0.003815]}
