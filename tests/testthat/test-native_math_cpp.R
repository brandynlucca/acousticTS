...
test_that("tmm_backscatter_cpp covers shape, boundary, and validation branches", {
  frequency <- 38e3
  n_max <- 1L
  ...
  expect_error(
    ...
    "'n_max' must match the frequency vector length."
  )

  sphere_pr <- acousticTS:::tmm_backscatter_cpp(
    frequency = frequency,
    theta_body = pi / 2,
    shape = "Sphere",
    shape_values = 0.01,
  ...
  sphere_rigid <- acousticTS:::tmm_backscatter_cpp(
    frequency = frequency,
    theta_body = pi / 2,
    shape = "Sphere",
    shape_values = 0.01,
  ...
  sphere_liquid <- acousticTS:::tmm_backscatter_cpp(
    frequency = frequency,
    theta_body = pi / 2,
    shape = "Sphere",
    shape_values = 0.01,
  ...
  prolate_rigid <- acousticTS:::tmm_backscatter_cpp(
    frequency = frequency,
    theta_body = pi / 2,
    shape = "ProlateSpheroid",
    shape_values = c(0.03, 0.01),
    boundary = "fixed_rigid",
    sound_speed_sw = 1477.3,
    density_sw = 1026.8,
    density_body = 1028.9,
  ...
  oblate_rigid <- acousticTS:::tmm_backscatter_cpp(
    frequency = frequency,
    theta_body = pi / 2,
    shape = "OblateSpheroid",
    shape_values = c(0.01, 0.02),
    boundary = "fixed_rigid",
    sound_speed_sw = 1477.3,
    density_sw = 1026.8,
    density_body = 1028.9,
  ...
  cylinder_rigid <- acousticTS:::tmm_backscatter_cpp(
    frequency = frequency,
    theta_body = pi / 2,
    shape = "Cylinder",
    shape_values = c(0.02, 0.005),
    boundary = "fixed_rigid",
    sound_speed_sw = 1477.3,
    density_sw = 1026.8,
    density_body = 1028.9,
  ...
  for (res in list(
    ...
    expect_true(is.finite(Re(res[[1]])) || is.finite(Im(res[[1]])))
  }
