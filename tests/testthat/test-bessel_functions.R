...
test_that("Spherical Bessel sequence matrix matches scalar API", {
  orders <- 0:28
  z_j <- c(0.15, 1.2, 9)
  seq_j <- acousticTS:::spherical_bessel_sequence_matrix_cpp(orders, z_j, "js")
  ...
  z_h <- c(1.2, 9)
  seq_h <- acousticTS:::spherical_bessel_sequence_matrix_cpp(orders, z_h, "hs")
