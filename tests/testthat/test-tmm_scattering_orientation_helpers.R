...
test_that(
  paste0(
    "TMM scattering helper vectors, weights, and orientation utilities cover ",
    "edge branches"
  ),
  {
    expect_error(
    ...
    expect_error(
      acousticTS:::.tmm_angle_vector(c(0.1, 3.5),
        upper = pi, name =
          "theta_body"
      ),
      "'theta_body' must be <= "
...
test_that(
  "TMM scattering helper frequency and cylindrical branches cover fallbacks",
  {
