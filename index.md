...
model](articles/getting-started/getting-started-workflow.png)](https://brandynlucca.github.io/acousticTS/articles/getting-started/getting-started.html)
...
- Shape manipulation and
  ...
  workflows for resizing, resampling, bending, and repositioning
  targets.
...
include a minimal reproducible example and
[`sessionInfo()`](https://rdrr.io/r/utils/sessionInfo.html) when
reporting a problem.

`acousticTS` is licensed under
[GPL-3](https://www.gnu.org/licenses/gpl-3.0.html). Upstream code
attribution and license notices are provided in
[inst/COPYRIGHTS](https://brandynlucca.github.io/acousticTS/inst/COPYRIGHTS).
