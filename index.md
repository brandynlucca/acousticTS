...
cross-section* (σ_(bs), m²). Target strength (TS, dB re. 1 m²) is the
logarithmic representation of σ_(bs) where: TS = 10 log₁₀ (σ_(bs)). TS
can be used to convert integrated (e.g. nautical area scattering
coefficient, S_(A), dB re. 1(m² nmi⁻²) or volumetric backscatter
(e.g. S_(v), dB re. 1 m⁻¹) collected from fisheries acoustic surveys
into units of number density, such as the volumetric density of a fish
school (i.e. animals m⁻³). This parameter can also aid in classifying
