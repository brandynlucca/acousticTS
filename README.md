...
# acousticTS <img src="man/figures/logo.png" align="right" height="138" alt="acousticTS hex logo" />
...
- Convert integrated backscatter (e.g. $S_A$, NASC) or volumetric
  backscatter ($S_v$) into number density or biomass
